...
public class ProfileController {
    ...
    public ResponseEntity<Page<ProfileDTO>> findProfilesBySkill(@Nullable @RequestParam String firstSkill,  @RequestParam String secondSkill, @Nullable @RequestParam String filterXP, @Nullable Pageable pageable) {
